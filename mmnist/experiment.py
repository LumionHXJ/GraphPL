...
from mmnist.constants import indices, modality_dims, styles, style_weights
...
class MMNISTExperiment_impute(BaseExperiment_impute):
    ...
    def get_modality(self, modality_name):
        mod = CMNIST(modality_name, 
                     EncoderImg(self.flags, modality_dims[modality_name], styles[modality_name]),
                     DecoderImg(self.flags, modality_dims[modality_name], styles[modality_name]), 
                     modality_dims[modality_name],
                     styles[modality_name], self.flags.likelihood_mnist)
        return mod
