...
from muse_eicu.experiment import eicuExperiment_impute as MuseEicuExperiment_impute
...
def main_start(FLAGS):
    ...
    if FLAGS.dataset=='polymnist':
        ...
        FLAGS.num_features = len(alphabet);
        FLAGS.alpha_modalities = [FLAGS.div_weight_uniform_content, FLAGS.div_weight_m1_content,
                              FLAGS.div_weight_m2_content, FLAGS.div_weight_m3_content, FLAGS.div_weight_m4_content];
    ...
    elif FLAGS.dataset=='muse_eicu':
        FLAGS.num_mods = 6
        FLAGS.alpha_modalities = [1 / (FLAGS.num_mods + 1)]*(FLAGS.num_mods+1)
        logger.info("alpha_modalities:" + str(FLAGS.alpha_modalities))
        mst = MuseEicuExperiment_impute(FLAGS, alphabet)
